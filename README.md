...
```markdown
# Denys NTWARITAGANZWA - Personal Website
...
This website is designed to provide information about me, Denys NTWARITAGANZWA. It includes sections for:
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/dntwaritag/My-Portfolio.git
   ```
...
```
Here is the link to the project https://dntwaritag.github.io/My-Portfolio/ 
